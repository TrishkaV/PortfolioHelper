...
- Logic protects from going into "margin" (using debt provided by the broker to open new position) or "short selling" (selling something that one does not have with the promise of buying back later).
